package com.sirawuh.data.source.local
...
class PreferenceHelper(
    ...
    fun getStatusUserSession(): String? {
        return encryptedPreference.getString(KeyPrefConst.STATUSUSER, null)
    }
    ...
    fun saveStatusUserSession(statusUser: String) {
        kotlin.runCatching {
            encryptedPreference.edit().putString(KeyPrefConst.STATUSUSER, statusUser).apply()
        }.onFailure {
            error(it)
        }
    }
